...
function navi_a11y_render_skip_link() {
    ?>
    <a href="#navi-a11y-main-content" class="navi-a11y-skip-link"><?php esc_html_e( 'Aller au contenu', 'saito-navi' ); ?></a>
    <?php
}
...
function navi_a11y_render_panel() {
    ...
    <div id="navi-a11y-panel" class="navi-a11y-panel" tabindex="-1">
        <button type="button" class="navi-a11y-close" aria-label="<?php esc_attr_e( 'Fermer', 'saito-navi' ); ?>">✕</button>
        <div class="navi-a11y-scroll">
            <h3 class="navi-a11y-title"><?php esc_html_e( 'Accessibilité', 'saito-navi' ); ?></h3>

            <?php if ( ! empty( $navi_languages ) ) : ?>
            <div class="navi-a11y-row">
                <label for="navi-a11y-lang"><?php esc_html_e( 'Langue', 'saito-navi' ); ?></label>
            ...
            <div class="navi-a11y-row navi-a11y-row--gtranslate">
                <label id="navi-a11y-gtranslate-label"><?php esc_html_e( 'Langue', 'saito-navi' ); ?></label>
            ...
            <div class="navi-a11y-row">
                <span id="navi-a11y-textsize-label"><?php esc_html_e( 'Taille du texte', 'saito-navi' ); ?></span>
                <div class="navi-a11y-stepper">
                    <button type="button" id="navi-a11y-textsize-dec" aria-label="<?php esc_attr_e( 'Réduire la taille du texte', 'saito-navi' ); ?>" aria-describedby="navi-a11y-textsize-label">−</button>
                    <span id="navi-a11y-textsize-value" aria-live="polite">100%</span>
                    <button type="button" id="navi-a11y-textsize-inc" aria-label="<?php esc_attr_e( 'Augmenter la taille du texte', 'saito-navi' ); ?>" aria-describedby="navi-a11y-textsize-label">+</button>
                </div>
            </div>

            <div class="navi-a11y-row">
                <span><?php esc_html_e( 'Contraste élevé', 'saito-navi' ); ?></span>
            ...
            <div class="navi-a11y-row">
                <span><?php esc_html_e( 'Curseur agrandi', 'saito-navi' ); ?></span>
            ...
            <div class="navi-a11y-row">
                <span><?php esc_html_e( 'Souligner les liens', 'saito-navi' ); ?></span>
                <button type="button" id="navi-a11y-underline-toggle" class="navi-a11y-switch" aria-pressed="false">
                    <span class="navi-a11y-switch-knob"></span>
                </button>
            </div>

            <button type="button" id="navi-a11y-reset" class="navi-a11y-reset"><?php esc_html_e( 'Réinitialiser les réglages', 'saito-navi' ); ?></button>
        </div>
    </div>
    <?php
}
