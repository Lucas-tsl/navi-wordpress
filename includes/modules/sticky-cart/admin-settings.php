...
function navi_sticky_page_reglages_html() {
    ...
    <div class="wrap navi-admin">
        <?php
        navi_admin_page_header(
            __( 'Panier', 'navi' ),
            __( 'Le panneau panier détecte automatiquement le prix, le nom et l\'image du produit sur la fiche produit, en essayant plusieurs emplacements courants (blocs Gutenberg, WooCommerce classique, quelques variantes de thèmes répandues).', 'navi' )
        );
        ?>
