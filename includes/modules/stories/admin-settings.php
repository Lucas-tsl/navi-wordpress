...
function navi_stories_render_settings_panel() {
    ...
    wp_enqueue_script( 'navi-admin-stories-settings-js', NAVI_PLUGIN_URL . 'assets/js/admin-stories-settings.js', array( 'jquery' ), NAVI_VERSION, true );
    wp_localize_script(
        'navi-admin-stories-settings-js',
        'naviStoriesSettingsData',
        array(
            'bubbleBorderDefault'  => $bubbleBorderDefault,
            'defaultGradientAngle' => NAVI_STORIES_DEFAULT_GRADIENT_ANGLE,
        )
    );
    ?>
            ...
            <div class="navi-admin-card">
                ...
                <div class="navi-admin-card">
                    ...
                    <div style="display:flex; gap:32px; flex-wrap:wrap; align-items:flex-start; margin-top:16px;">
                        ...
                        <div class="navi-admin-preview" style="flex:0 0 220px; display:flex; align-items:center; justify-content:center; min-height:180px; padding:20px;">
            ...
            <div class="navi-stories-tab-panel" data-tab-panel="mockup" style="display:none;">
                ...
                <div class="navi-admin-card">
                    ...
                    <div style="display:flex; gap:32px; flex-wrap:wrap; align-items:flex-start; margin-top:16px;">
                        ...
                        <div class="navi-admin-preview" style="flex:0 0 220px; display:flex; align-items:center; justify-content:center; min-height:260px; padding:20px;">
